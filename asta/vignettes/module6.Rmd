...
#Dans les infoBoxs
accuracy <- nb_rs_metrics[nb_rs_metrics$.metric=="accuracy","mean"] %>% as.character()
sensitivity <- nb_rs_metrics[nb_rs_metrics$.metric=="sensitivity","mean"] %>% as.character()
specificity <- nb_rs_metrics[nb_rs_metrics$.metric=="sensitivity","mean"] %>% as.character()
