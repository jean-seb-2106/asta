...
vins_fit_lr1 %>% fit_resamples(folds) %>% collect_metrics()
...
vins_fit_lr1 %>% collect_metrics()
vins_fit_lr2 %>% collect_metrics()
vins_fit_rf1 %>% collect_metrics()
vins_fit_rf2 %>% collect_metrics()
...
```{r}
predict(vins_fit_lr1, train_data) 
```
